...
CREATE OR REPLACE
PROCEDURE REFRESH_S_ISO639_3RETIREMENTS
AS
    
    vTable_Name USER_TABLES.Table_Name%TYPE := 'S_ISO639_3RETIREMENTS';
    ...
    vURL CONSTANT VARCHAR2(4000 BYTE) := Get_Table_Refresh_Source_URL(vTable_Name);
