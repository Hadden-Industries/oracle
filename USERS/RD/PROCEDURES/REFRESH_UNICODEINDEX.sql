...
CREATE OR REPLACE
PROCEDURE REFRESH_UNICODEINDEX(gDownload IN INTEGER DEFAULT 1)
AS
    
    --Email variables
    vSubject VARCHAR2(78 CHAR) := 'UNICODEINDEX ' || TO_CHAR(SYSDATE, 'YYYY-MM-DD"T"HH24:MI:SS');
    ...
    vURL VARCHAR2(4000 BYTE) := 'http://unicode.org/Public/UCD/latest/ucd/Index.txt';
    ...
    BEGIN
        ...
        IF (gDownload = 1) THEN
            ...
            (
                SELECT Table_Name
                FROM USER_TABLES
                WHERE Table_Name IN ('S_UNICODEINDEX')
                ORDER BY Table_Name
            ) LOOP
        ...
        (
            SELECT Table_Name
            FROM USER_TABLES
            WHERE Table_Name IN ('UNICODEINDEX')
            ORDER BY Table_Name
        ) LOOP
        ...
        /*IF ((nDeleted + nInserted) > 0) THEN
            ...
            BEGIN
                ...
                GOOGLE.Import_Table('UNICODEINDEX', vGoogleOutput);
