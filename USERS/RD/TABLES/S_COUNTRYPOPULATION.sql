/*
--http://esa.un.org/unpd/wpp/DVD/Files/1_Indicators%20(Standard)/ASCII_FILES/WPP2015_DB02_Populations_Annual.zip
...
*/
--DROP TABLE S_COUNTRYPOPULATION PURGE;
CREATE
TABLE S_COUNTRYPOPULATION
(
    LocID VARCHAR2(4 BYTE),
...
(
    ...
    (
        ...
        (
            LocID CHAR(4),
            "LOCATION" CHAR(100),
            VarID INTEGER EXTERNAL(2),
            Variant CHAR(100),
            "TIME" INTEGER EXTERNAL(4),
            MidPeriod CHAR(6),
            PopMale CHAR(100),
            PopFemale CHAR(100),
            PopTotal CHAR(100) LRTRIM
        )
    )
    LOCATION('WPP2017_TotalPopulationBySex.csv')
)
PARALLEL
NOMONITORING
--REJECT LIMIT 1
