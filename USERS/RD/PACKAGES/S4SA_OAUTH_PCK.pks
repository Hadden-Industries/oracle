...
gc_ObjectName constant varchar2(128 BYTE) := 'S4SA_AUTH_PCK';
...
type tp_settings is record
  ...
  , login_request_facebook_debug varchar2(16) -- 'FCB_LOGIN_DEBUG';
...
type tp_provider_settings is record
  ...
  , redirect_uri_debug varchar2(1000)
